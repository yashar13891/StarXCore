...
public class gmspcommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("teststarxcore.gmsp")) {
        ...
        FileConfiguration config = Teststarxcore.getInstance().getConfig();
        String message = config.getString("messages.spectator", "&x&E&3&3&4&1&4ℹ &eʏᴏᴜʀ ɢᴀᴍᴇ ᴍᴏᴅᴇ ʜᴀꜱ ʙᴇᴇɴ ᴄʜᴀɴɢᴇᴅ ᴛᴏ &cꜱᴘᴇᴄᴛᴀᴛᴏʀ.");
        String targetMessage = config.getString("messages.target", "&aYou changed &b%player%'s &agame mode to &bSpectator.");
